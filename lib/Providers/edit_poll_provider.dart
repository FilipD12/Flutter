...
class EditPollProvider extends ChangeNotifier {
  ...
  // Edit poll
  void editPoll({required String pollId, required Map<String, dynamic> updatedData}) {
    pollCollection.doc(pollId).update(updatedData).then((_) {
